...
cap = cv2.VideoCapture('testdrive-1.m4v')
...
low_thresh = (values[0], values[1], values[2]) #(0, 137, 168) #colorsys.rgb_to_hsv(199,79,55)
high_thresh = (values[3], values[4], values[5]) #(182, 255, 255)#colorsys.rgb_to_hsv(219,98,51)
